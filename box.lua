...
local SolarisLib = {
    Themes = {
        Default = {
            MainFrame = Color3.fromRGB(19,19,19),
            TopBar = Color3.fromRGB(32,32,32),
            TextColor =  Color3.fromRGB(245,245,245),
            Menu = Color3.fromRGB(32,32,32),
            TabToggled = Color3.fromRGB(148,33,33),
            Button = Color3.fromRGB(148,33,33),
            ButtonHold = Color3.fromRGB(110,24,24),
            Toggle = Color3.fromRGB(29,29,29),
            ToggleFrame = Color3.fromRGB(211,47,47),
            ToggleToggled = Color3.fromRGB(211,47,47),
            Slider = Color3.fromRGB(29,29,29),
            SliderBar = Color3.fromRGB(19,19,19),
            SliderInc = Color3.fromRGB(211,47,47),
            Dropdown = Color3.fromRGB(29,29,29),
            DropdownItem = Color3.fromRGB(29,29,29),
            Textbox = Color3.fromRGB(29,29,29),
            TextboxFrame = Color3.fromRGB(59,13,13),
            Colorpicker = Color3.fromRGB(29,29,29),
            Label = Color3.fromRGB(29,29,29),
            Bind = Color3.fromRGB(29,29,29)
        },
        Discord = {
...
print("HadesHub has been Loaded!")
...
function SolarisLib:New(Config)
    ...
    function MusicConstructor()
        ...
        spawn(function()
            while wait() do
                ...
                MusicFrame.Frame.TopBar.CloseBtn.Ico.ImageColor3 = Color3.fromRGB(211,47,47)
    ...
    function SettingsConstructor()
        ...
        spawn(function()
            while wait() do
                ...
                SFrame.TopBar.CloseBtn.Ico.ImageColor3 = Color3.fromRGB(211,47,47)
                SFrame.TopBar.TopFrameTitle.TextColor3 = Color3.fromRGB(211,47,47)
            ...
            function TabHold:BindSetting(title, desc, def, path)
                ...
                spawn(function()
                    while wait() do
                        ...
                        Bind.BText.TextColor3 = Color3.fromRGB(211,47,47)
        ...
        appearance:Dropdown("Theme", "The look of the user interface", {"Default", "Discord", "Red", "Green", "Blue", "HadesHub"}, "Default", "Theme")
    ...
    spawn(function()
        while wait() do
            ...
            MFrame.TopBar.ButtonHolder.CloseBtn.Ico.ImageColor3 = Color3.fromRGB(211,47,47)
            MFrame.TopBar.ButtonHolder.MenuBtn.Ico.ImageColor3 = Color3.fromRGB(211,47,47)
            MFrame.TopBar.ButtonHolder.SearchBtn.Ico.ImageColor3 = Color3.fromRGB(211,47,47)
            MFrame.TopBar.TabListBtn.ImageColor3 = Color3.fromRGB(211,47,47)
            MFrame.TopBar.TopFrameTitle.TextColor3 = Color3.fromRGB(211,47,47)
            MFrame.TopBar.TopFrameTitle.RichText = true
            MFrame.TabMenu.Menu.BackgroundColor3 = SolarisLib.Themes[SolarisLib.Settings.Theme].Menu
            MFrame.TabMenu.Menu.Top.MenuCloseBtn.ImageLabel.ImageColor3 = Color3.fromRGB(211,47,47)
            ...
            function ItemHold:Slider(text,min,max,start,inc,flag,callback)
                ...
                spawn(function()
                    while wait() do
                       ...
                       SliderMain.SliderVal.TextColor3 = Color3.fromRGB(211,47,47)
                    end
                end)
            ...
            function ItemHold:Dropdown(text,list,def,flag,callback)
                ...
                spawn(function()
                    while wait() do
                       ...
                       DropMain.Btn.Title.TextColor3 = SolarisLib.Themes[SolarisLib.Settings.Theme].TextColor
                       DropMain.Btn.Ico.ImageColor3 = Color3.fromRGB(211,47,47)
                    end
                end)
            ...
            function ItemHold:Bind(text,preset,holdmode,flag,callback)
                ...
                spawn(function()
                    while wait() do
                       ...
                       BindFrame.BText.TextColor3 = Color3.fromRGB(211,47,47)
                    end
                end)
